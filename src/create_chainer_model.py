...
from model import *
# from Objectness import MyFcn32sWithAnySize
...
# objectness = MyFcn32sWithAnySize()
# print('copy weights')
# copy_model(ref, objectness)

# print('save "ingredients.model"')
# serializers.save_npz('ingredients.model', objectness)
